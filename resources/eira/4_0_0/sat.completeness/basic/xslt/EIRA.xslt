...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="EIRA v4.0.0 - SAT Completeness Profile - Basic level">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EIRA v4.0.0 - SAT Completeness Profile - Basic level</svrl:text>
