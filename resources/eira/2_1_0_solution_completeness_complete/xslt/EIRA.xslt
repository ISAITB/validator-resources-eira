...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="EIRA v2.1.0 - Solution Completeness Profile - Complete level">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EIRA v2.1.0 - Solution Completeness Profile - Complete level</svrl:text>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(a:views/a:diagrams/a:view[./a:name = 'Legal view'])/count(.) = 1">
          <xsl:attribute name="id">EIRA-001</xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(a:views/a:diagrams/a:view[./a:name = 'Organisational view'])/count(.) = 1">
          ...
          <svrl:text>[EIRA-002] The model must define a view named 'Organisational view'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(a:views/a:diagrams/a:view[./a:name = 'Semantic view'])/count(.) = 1">
          ...
          <svrl:text>[EIRA-003] The model must define a view named 'Semantic view'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(a:views/a:diagrams/a:view[./a:name = 'Technical view - application'])/count(.) = 1">
          ...
          <svrl:text>[EIRA-004] The model must define a view named 'Technical view - application'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(a:views/a:diagrams/a:view[./a:name = 'Technical view - infrastructure'])/count(.) = 1">
          ...
          <svrl:text>[EIRA-005] The model must define a view named 'Technical view - infrastructure'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(a:views/a:diagrams/a:view[./a:name = 'Highlevel viewpoint'])/count(.) = 1">
          ...
          <svrl:text>[EIRA-006] The model must define a view named 'Highlevel viewpoint'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="let $modelAttributes := (a:properties) return (every $eiraModelAttributeName in document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[(let $propId := string(@identifier) return exists(document('eira/EIRA.xml')/a:model/a:properties/a:property[string(@propertyDefinitionRef) = $propId]))]/a:name/string(.) satisfies (($eiraModelAttributeName = 'ID' or $eiraModelAttributeName = 'dct:description' or $eiraModelAttributeName = 'eira:iop_score_governance' or $eiraModelAttributeName = 'eira:iop_score_h2m' or $eiraModelAttributeName = 'eira:iop_score_m2m' or $eiraModelAttributeName = 'eira:iop_score_overall' or $eiraModelAttributeName = 'eira:iop_score_sw_architecture' or $eiraModelAttributeName = 'dcat:landingPage') or exists($modelAttributes/a:property[(let $modelPropId := string(@propertyDefinitionRef) return exists(/a:model/a:propertyDefinitions/a:propertyDefinition[string(@identifier) = $modelPropId and string(a:name) = $eiraModelAttributeName])) and normalize-space(string(./a:value)) != ''])))">
          ...
          <svrl:text>[EIRA-007] The model is missing required attribute(s) [<xsl:text />
	...
	<!--RULE -->
<xsl:template match="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+')]" mode="M6" priority="1002">
    <svrl:fired-rule context="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+')]" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $sbbDeclaredAbbName in normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')), $elementType in string(@xsi:type) satisfies (let $abb := document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier)] and string(a:name) = $sbbDeclaredAbbName] return not(exists($abb)) or $abb/@xsi:type = $elementType)" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $sbbDeclaredAbbName in normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')), $elementType in string(@xsi:type) satisfies (let $abb := document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier)] and string(a:name) = $sbbDeclaredAbbName] return not(exists($abb)) or $abb/@xsi:type = $elementType)">
          <xsl:attribute name="id">EIRA-008</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-008] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
            <xsl:text />) has an invalid element type '<xsl:text />
            <xsl:value-of select="string(@xsi:type)" />
            <xsl:text />'. Expected element type '<xsl:text />
            <xsl:value-of select="let $elementName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return string(document('eira/EIRA.xml')/a:model/a:elements/a:element[a:name = $elementName]/@xsi:type)" />
            <xsl:text />'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="let $sbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(a:name) = $sbbName])" />
      <xsl:otherwise>
        <svrl:failed-assert test="let $sbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(a:name) = $sbbName])">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="let $sbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return (let $abb := document('eira/EIRA.xml')/a:model/a:elements/a:element[string(a:name) = $sbbName] return (not(exists($abb)) or not(exists($abb/a:properties/a:property[string(./a:value) = 'Obsolete' and string(./@propertyDefinitionRef) = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./a:name) = 'eira:ABB_Status']/@identifier)]))))" />
      <xsl:otherwise>
        <svrl:failed-assert test="let $sbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return (let $abb := document('eira/EIRA.xml')/a:model/a:elements/a:element[string(a:name) = $sbbName] return (not(exists($abb)) or not(exists($abb/a:properties/a:property[string(./a:value) = 'Obsolete' and string(./@propertyDefinitionRef) = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./a:name) = 'eira:ABB_Status']/@identifier)]))))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="false()">
          ...
          <svrl:text>[EIRA-012] ABBs must not be defined in a solution.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="every $elementName in string(a:name), $elementType in string(@xsi:type) satisfies ($elementType = string(document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier)] and string(a:name) = $elementName]/@xsi:type))">
          ...
          <svrl:text>[EIRA-013] ABB defined with element type '<xsl:text />
            <xsl:value-of select="string(@xsi:type)" />
...
<xsl:template match="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+')]/a:properties/a:property[(let $propId := string(./@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId]/a:name) return (let $abbName := normalize-space(substring-before(normalize-space(substring-after(string(./../../a:name), '&lt;&lt;')), '>>')) return (exists(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./a:name) = $propertyName and (let $abbPropId := string(./@identifier) return (exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(./a:name) = $abbName]/a:properties/a:property[string(./@propertyDefinitionRef) = $abbPropId])))])))))]" mode="M6" priority="1000">
    <svrl:fired-rule context="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+')]/a:properties/a:property[(let $propId := string(./@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId]/a:name) return (let $abbName := normalize-space(substring-before(normalize-space(substring-after(string(./../../a:name), '&lt;&lt;')), '>>')) return (exists(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./a:name) = $propertyName and (let $abbPropId := string(./@identifier) return (exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(./a:name) = $abbName]/a:properties/a:property[string(./@propertyDefinitionRef) = $abbPropId])))])))))]" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="let $pValue := normalize-space(string(a:value)) return (let $pIdentifier := string(@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $pIdentifier]/a:name) return (($propertyName = 'ID') or (let $abbName := normalize-space(substring-before(normalize-space(substring-after(string(../../a:name), '&lt;&lt;')), '>>')) return (let $abbPropDefinition := (replace(string(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(./a:name) = $abbName]/a:properties/a:property[(let $abbPropId := string(./@propertyDefinitionRef) return (exists(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $abbPropId and string(./a:name) = $propertyName])))]/a:value), '\-', '~')) return (if (matches($abbPropDefinition, '\[(([\w\d\s\|]+)|([\w\d\s]+))\]')) then let $validTokens := tokenize(substring-before(substring-after($abbPropDefinition, '['), ']'), '([ ]*\|[ ]*)|(^[ ]+)|([ ]+$)') return (index-of($validTokens, replace($pValue, '\-', '~')) > 0) else if ($abbPropDefinition != '') then replace($pValue, '\-', '~') = $abbPropDefinition else true()))))))" />
      <xsl:otherwise>
        <svrl:failed-assert test="let $pValue := normalize-space(string(a:value)) return (let $pIdentifier := string(@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $pIdentifier]/a:name) return (($propertyName = 'ID') or (let $abbName := normalize-space(substring-before(normalize-space(substring-after(string(../../a:name), '&lt;&lt;')), '>>')) return (let $abbPropDefinition := (replace(string(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(./a:name) = $abbName]/a:properties/a:property[(let $abbPropId := string(./@propertyDefinitionRef) return (exists(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $abbPropId and string(./a:name) = $propertyName])))]/a:value), '\-', '~')) return (if (matches($abbPropDefinition, '\[(([\w\d\s\|]+)|([\w\d\s]+))\]')) then let $validTokens := tokenize(substring-before(substring-after($abbPropDefinition, '['), ']'), '([ ]*\|[ ]*)|(^[ ]+)|([ ]+$)') return (index-of($validTokens, replace($pValue, '\-', '~')) > 0) else if ($abbPropDefinition != '') then replace($pValue, '\-', '~') = $abbPropDefinition else true()))))))">
          ...
          <svrl:text>[EIRA-014] SBB '<xsl:text />
            ...
            <xsl:value-of select="let $pIdentifier := string(@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $pIdentifier]/a:name) return (let $abbName := normalize-space(substring-before(normalize-space(substring-after(string(../../a:name), '&lt;&lt;')), '>>')) return (string(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(./a:name) = $abbName]/a:properties/a:property[(let $abbPropId := string(./@propertyDefinitionRef) return (exists(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $abbPropId and string(./a:name) = $propertyName])))]/a:value))))" />
            <xsl:text />'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="let $propValue := normalize-space(string(./a:value)) return (let $propId := string(./@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId]/a:name) return (not($propertyName = 'eira:reusability' and $propValue = 'Reusable') or (let $reuseStatusProperty := (../a:property[(let $propId := string(./@propertyDefinitionRef) return (exists(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId and string(./a:name) = 'eira:reuse_status'])))]) return (exactly-one($reuseStatusProperty) and normalize-space(string($reuseStatusProperty/a:value)) != '')))))" />
      <xsl:otherwise>
        <svrl:failed-assert test="let $propValue := normalize-space(string(./a:value)) return (let $propId := string(./@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId]/a:name) return (not($propertyName = 'eira:reusability' and $propValue = 'Reusable') or (let $reuseStatusProperty := (../a:property[(let $propId := string(./@propertyDefinitionRef) return (exists(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId and string(./a:name) = 'eira:reuse_status'])))]) return (exactly-one($reuseStatusProperty) and normalize-space(string($reuseStatusProperty/a:value)) != '')))))">
          ...
          <svrl:text>[EIRA-015] SBB '<xsl:text />
            ...
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(../../a:name), '&lt;&lt;')), '>>'))" />
            <xsl:text />) that is defined as reusable must define attribute 'eira:reuse_status'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="let $propValue := normalize-space(string(./a:value)) return (let $propId := string(./@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId]/a:name) return (not($propertyName = 'eira:reusability' and $propValue = 'Not reusable') or (let $reuseStatusProperty := (../a:property[(let $propId := string(./@propertyDefinitionRef) return (exists(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId and string(./a:name) = 'eira:reuse_status'])))]) return (not(exists($reuseStatusProperty)) or (exactly-one($reuseStatusProperty) and normalize-space(string($reuseStatusProperty/a:value)) = ''))))))" />
      <xsl:otherwise>
        <svrl:failed-assert test="let $propValue := normalize-space(string(./a:value)) return (let $propId := string(./@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId]/a:name) return (not($propertyName = 'eira:reusability' and $propValue = 'Not reusable') or (let $reuseStatusProperty := (../a:property[(let $propId := string(./@propertyDefinitionRef) return (exists(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $propId and string(./a:name) = 'eira:reuse_status'])))]) return (not(exists($reuseStatusProperty)) or (exactly-one($reuseStatusProperty) and normalize-space(string($reuseStatusProperty/a:value)) = ''))))))">
          ...
          <svrl:text>[EIRA-016] SBB '<xsl:text />
            ...
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(../../a:name), '&lt;&lt;')), '>>'))" />
            <xsl:text />) that is defined as not reusable must not define attribute 'eira:reuse_status'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="let $pElement := (./../..) return (let $pIdentifier := string(@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $pIdentifier]/a:name) return (let $abbName := normalize-space(substring-before(normalize-space(substring-after(string(../../a:name), '&lt;&lt;')), '>>')) return (let $abbPropDefinition := (replace(string(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(./a:name) = $abbName]/a:properties/a:property[(let $abbPropId := string(./@propertyDefinitionRef) return (exists(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $abbPropId and string(./a:name) = $propertyName])))]/a:value), '\-', '~')) return (if (matches($abbPropDefinition, '\[(([\w\d\s\|]+)|([\w\d\s]+))\]\*')) then true() else count($pElement/a:properties/a:property[string(./@propertyDefinitionRef) = $pIdentifier]) = 1)))))" />
      <xsl:otherwise>
        <svrl:failed-assert test="let $pElement := (./../..) return (let $pIdentifier := string(@propertyDefinitionRef) return (let $propertyName := string(/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $pIdentifier]/a:name) return (let $abbName := normalize-space(substring-before(normalize-space(substring-after(string(../../a:name), '&lt;&lt;')), '>>')) return (let $abbPropDefinition := (replace(string(document('eira/EIRA.xml')/a:model/a:elements/a:element[string(./a:name) = $abbName]/a:properties/a:property[(let $abbPropId := string(./@propertyDefinitionRef) return (exists(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[string(./@identifier) = $abbPropId and string(./a:name) = $propertyName])))]/a:value), '\-', '~')) return (if (matches($abbPropDefinition, '\[(([\w\d\s\|]+)|([\w\d\s]+))\]\*')) then true() else count($pElement/a:properties/a:property[string(./@propertyDefinitionRef) = $pIdentifier]) = 1)))))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'Legal view']//a:node[string(@elementRef) = $elementId])">
          <xsl:attribute name="id">EIRA-018</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-018] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'Organisational view']//a:node[string(@elementRef) = $elementId])">
          <xsl:attribute name="id">EIRA-019</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-019] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'Semantic view']//a:node[string(@elementRef) = $elementId])">
          <xsl:attribute name="id">EIRA-020</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-020] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'Technical view - application']//a:node[string(@elementRef) = $elementId])">
          ...
          <svrl:text>[EIRA-021] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'Technical view - infrastructure']//a:node[string(@elementRef) = $elementId])">
          ...
          <svrl:text>[EIRA-022] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
...
<xsl:template match="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+') and (let $declaredAbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier) and starts-with(string(a:value), 'eira:')] and string(a:name) = $declaredAbbName and (let $abbElementId := string(@identifier) return exists(document('eira/EIRA.xml')/a:model/a:organizations//a:item[string(a:label) = 'Interoperability principles Concepts']/a:item[string(@identifierRef) = $abbElementId]))]))]" mode="M7" priority="1001">
    <svrl:fired-rule context="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+') and (let $declaredAbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier) and starts-with(string(a:value), 'eira:')] and string(a:name) = $declaredAbbName and (let $abbElementId := string(@identifier) return exists(document('eira/EIRA.xml')/a:model/a:organizations//a:item[string(a:label) = 'Interoperability principles Concepts']/a:item[string(@identifierRef) = $abbElementId]))]))]" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'EIF Underlying Principles view']//a:node[string(@elementRef) = $elementId])" />
      <xsl:otherwise>
        <svrl:failed-assert test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'EIF Underlying Principles view']//a:node[string(@elementRef) = $elementId])">
          <xsl:attribute name="id">EIRA-023</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-023] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
            <xsl:text />) is not present in the model's EIF Underlying Principles view.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M7" select="*" />
	...
	<!--RULE -->
<xsl:template match="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+') and (let $declaredAbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return ($declaredAbbName = 'Technical Interoperability Specification' or $declaredAbbName = 'Technical Specification'))]" mode="M7" priority="1000">
    <svrl:fired-rule context="/a:model/a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*.+[ \t]*>>.+') and (let $declaredAbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return ($declaredAbbName = 'Technical Interoperability Specification' or $declaredAbbName = 'Technical Specification'))]" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="let $elementId := string(@identifier) return exists(/a:model/a:views/a:diagrams/a:view[string(a:name) = 'Technical view - application' or string(a:name) = 'Technical view - infrastructure']//a:node[string(@elementRef) = $elementId])">
          <xsl:attribute name="id">EIRA-024</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-024] SBB '<xsl:text />
            <xsl:value-of select="normalize-space(substring-after(string(a:name), '>>'))" />
            <xsl:text />' (<xsl:text />
            <xsl:value-of select="normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>'))" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Public Policy[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-01</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Public Policy' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Public Service Provider[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Public Service Provider[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-02</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Public Service Provider' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Public Service Consumer[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Public Service Consumer[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-03</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Public Service Consumer' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Public Service[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Public Service[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-04</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Public Service' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Business Capability[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Business Capability[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-05</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Business Capability' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Exchange of Business Information[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Exchange of Business Information[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-06</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Exchange of Business Information' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Business Information[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Business Information[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-07</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Business Information' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Representation[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*Representation[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-025-08</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-025] All ABBs in the high-level overview must be defined. No 'Representation' SBB is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*(Data|Descriptive Metadata|Transactional Data|Master Data|Open Data|Base Registry|Reference Data)[ \t]*>>.*')])" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*(Data|Descriptive Metadata|Transactional Data|Master Data|Open Data|Base Registry|Reference Data)[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-026-01</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-026] All ABBs in the high-level overview must be defined. No 'Data' SBB (or a specialization) is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(@xsi:type), 'CommunicationNetwork|TechnologyService|Node') and (let $declaredAbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier) and starts-with(string(a:value), 'eira:')] and string(a:name) = $declaredAbbName]))])">
          <xsl:attribute name="id">EIRA-026-02</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-026] All ABBs in the high-level overview must be defined. No 'Hosting and Networking Infrastructure' SBB (or a specialization) is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(@xsi:type), 'ApplicationService') and (let $declaredAbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier) and starts-with(string(a:value), 'eira:')] and string(a:name) = $declaredAbbName]))])">
          <xsl:attribute name="id">EIRA-026-03</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-026] All ABBs in the high-level overview must be defined. No 'Application Service' SBB (or a specialization) is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(@xsi:type), 'ApplicationComponent') and (let $declaredAbbName := normalize-space(substring-before(normalize-space(substring-after(string(a:name), '&lt;&lt;')), '>>')) return exists(document('eira/EIRA.xml')/a:model/a:elements/a:element[a:properties/a:property[@propertyDefinitionRef = string(document('eira/EIRA.xml')/a:model/a:propertyDefinitions/a:propertyDefinition[a:name = 'dct:type']/@identifier) and starts-with(string(a:value), 'eira:')] and string(a:name) = $declaredAbbName]))])">
          <xsl:attribute name="id">EIRA-026-04</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-026] All ABBs in the high-level overview must be defined. No 'Digital Service Infrastructure' SBB (or a specialization) is defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(a:elements/a:element[matches(string(a:name), '&lt;&lt;[ \t]*(Machine to Machine Interface|Human Interface)[ \t]*>>.*')])">
          <xsl:attribute name="id">EIRA-027-01</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[EIRA-027] All ABBs in the high-level overview must be defined. At least one SBB for ABBs ['Machine to Machine Interface', 'Human Interface'] must be defined.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M8" select="*" />
