...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="EIRA v3.1.0 - Detail-Level SAT Completeness Profile - Basic level">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EIRA v3.1.0 - Detail-Level SAT Completeness Profile - Basic level</svrl:text>
