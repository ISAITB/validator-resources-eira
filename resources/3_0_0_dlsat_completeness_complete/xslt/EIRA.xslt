...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="EIRA v3.0.0 - Detail-Level SAT Completeness Profile - Complete level">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EIRA v3.0.0 - Detail-Level SAT Completeness Profile - Complete level</svrl:text>
