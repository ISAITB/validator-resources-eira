...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="EIRA v4.0.0 - High-Level SAT Completeness Profile - Complete level">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EIRA v4.0.0 - High-Level SAT Completeness Profile - Complete level</svrl:text>
