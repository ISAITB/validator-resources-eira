<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="Step.03">
	<rule context="$Model">
        ...
        <assert test="$EIRA-018-04" flag="fatal" id="EIRA-018-04">[EIRA-018] All ABBs in the high-level overview must be defined. No 'Interoperable Digital Public Service' SBB is defined.</assert>
